-- +goose Up
-- -----------------------------------------------------------------------------
-- Bucket and Credential Provisioning
--
-- Author: Alex Freidah
--
...
--
-- A grant carries no permission column, and its absence means full access to
-- the named bucket. Nothing limits a user to one grant.
--
